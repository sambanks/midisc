...
from midisc.parts import (  # noqa: E402
    ...
    build_clear_part, build_dirty, build_pack, build_reload_after, build_reload_ui,
    build_save_ui, build_unpack)
from midisc.hold import (  # noqa: E402
    build_addi_d0, build_addi_d1, build_dial, build_enc_press_hook, build_enc_unlock,
    build_hold_store, build_press_refresh)
...
from midisc.morph import (  # noqa: E402
    ...
    build_write_remixed, build_xf_after, build_xf_mix_out)
...
REGIONS = {
    "safe_cave": (mm.SAFE_CAVE, [
        ("dirty", build_dirty, ()), ("clr_pt", build_clear_part, ()),
